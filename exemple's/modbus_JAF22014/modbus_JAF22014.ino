...
// ============================================================================
// НАСТРОЙКА ПИНОВ ДЛЯ ВАШЕЙ ВЕРСИИ KC868-A6
// ============================================================================
// ВНИМАНИЕ! Выберите правильный вариант для вашей платы!
...
// Если не требуется, закомментируйте эту строку
#define RS485_DE_RE 4 

// ============================================================================
// НАСТРОЙКА MODBUS
// ============================================================================
#define SLAVE_ADDRESS 1          // Адрес вашего JAF22014 (по умолчанию 1)
#define BAUD_RATE 9600           // Скорость обмена (должна совпадать с настройками JAF22014)
...
// Пример: если raw = 0x0028 (40), то температура = 0°C
